...
ustar_n = ustar[(abs(ustar['1/L'])<0.0001) &
		(ustar['ustar[m/s]     ']>0.31) &
		(ustar['ustar[m/s]     ']<0.55)
	       ]
...
ustar_i = ustar[(ustar['1/L']<-0.045) &
		(ustar['1/L']>-0.55) &
		(ustar['ustar[m/s]     ']>0.35) &
		(ustar['ustar[m/s]     ']<0.5)
	       ]
...
ustar_e = ustar[(ustar['1/L']>0.015) &
		(ustar['1/L']<0.6) &
		(ustar['ustar[m/s]     ']>0.305) &
		(ustar['ustar[m/s]     ']<0.55)
	       ]
